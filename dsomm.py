...
def parse_activity(g, a, subdimension_uri):
    """
    risk: |
      Quality is not visible to everyone, quality
      checks are distributed or manually
      and not deterministic.
    measure: Use continuous automated building and testing of the software.
    md-description: |
      ## Benefits:
      Quality is visible to everyone
      There is a single instance deciding whether the
      code meets its quality (single ground of truth).
